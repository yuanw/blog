...
(function($PS) {
  ...
  var stateOnlyStaticComponent = function (state) {
      return function (dynamicRenderer) {
  ...
  var simpleIntState = function (state) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("The state was: " + Data_Show.show(Data_Show.showInt)(state)) ]);
  };
  var selectElement$prime = function (errorMessage) {
      return function (query) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement(query))(function (maybeElem) {
              return Data_Maybe.maybe(Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff)(Effect_Exception.error(errorMessage)))(Control_Applicative.pure(Effect_Aff.applicativeAff))(maybeElem);
          });
      };
  };
  var runStateOnlyDynamicRenderer = function (firstState) {
      return function (secondState) {
          return function (thirdState) {
              return function (rendererFunction) {
                  return Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
                      return Control_Bind.bind(Effect_Aff.bindAff)(selectElement$prime("could not find 'div#first'")("#first"))(function (div1) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(selectElement$prime("could not find 'div#second'")("#second"))(function (div2) {
                              return Control_Bind.bind(Effect_Aff.bindAff)(selectElement$prime("could not find 'div#third'")("#third"))(function (div3) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(Halogen_VDom_Driver.runUI(stateOnlyStaticComponent(firstState)(rendererFunction))(Data_Unit.unit)(div1)))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(Halogen_VDom_Driver.runUI(stateOnlyStaticComponent(secondState)(rendererFunction))(Data_Unit.unit)(div2)))(function () {
                                          return Data_Functor["void"](Effect_Aff.functorAff)(Halogen_VDom_Driver.runUI(stateOnlyStaticComponent(thirdState)(rendererFunction))(Data_Unit.unit)(div3));
                                      });
                                  });
                              });
                          });
  ...
  var main = runStateOnlyDynamicRenderer(1)(2)(3)(simpleIntState);
  exports["main"] = main;
  exports["simpleIntState"] = simpleIntState;
  exports["runStateOnlyDynamicRenderer"] = runStateOnlyDynamicRenderer;
  exports["stateOnlyStaticComponent"] = stateOnlyStaticComponent;
  exports["selectElement'"] = selectElement$prime;
})(PS);
PS["Frontend"].main();